# Stage 0A contract v2: executable structural-causal environment specification

Status: version 2, 6 September 2026. Supersedes `stage-0a-contract-draft.md` after the Codex final critique (F1, F2, F3, F4, F7, F9, F10, F11). This version is intended to be implemented as written; every symbol here becomes a name in code.
...
Paper 1 primary: p_c and α^S. Secondary: α^R, α^P, R̂, assignment.

# Stage 0A contract v3.5 (consolidated, normative)

**Status:** version 3.5, 7 September 2026, encoding D-9 as adjudicated after two-model verification (`d9-adjudication.md`). **Supersedes** `stage-0a-contract-v3.4.md`, `stage-0a-contract-v3.3.md`, `stage-0a-contract-v3.2.md`, `stage-0a-contract-v3.1.md`, `stage-0a-contract-v3.md`, `stage-0a-contract-draft.md`, `stage-0a-contract-v2.md`, `stage-0a-contract-v2.1.md`, `stage-0a-contract-v2.2.md`, and the contract-related patches in `gemini-v3.1/`, `gemini-v3.2/`, `gemini-v3.3/`. Incorporates Codex v3.4 findings L1, L4, L5, L9, L12, L13. Sections are marked **[N]** normative (implement exactly) or **[I]** informative.
